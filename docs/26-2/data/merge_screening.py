...
TEAMS = {
 1: ('테크·전동화', '배준서', [
    ...
    ('2차전지·소재',         '1e838a93-ICOK___________1___.xlsx', '1_2차전지·소재',         None),
    ('소프트웨어·인터넷·게임',  '1e838a93-ICOK___________1___.xlsx', '1_소프트웨어·인터넷·게임',  None),
 ...
 2: ('중후장대·인프라', '이재우', [
    ...
    ('조선·기자재',          '2dc6eb75-ICOK________________________.xlsx','2_조선·기자재',        '이준성'),
    ('기계·건설·로봇',        '2439e087-____ICOK__________.xlsx',          '2_기계·건설·로봇',     '김범준'),
    ('방산·우주',            '1e838a93-ICOK___________1___.xlsx',         '2_방산·우주',          None),
...
NOTES = {
 1: lambda d, n, c, b: [
    ...
    ('2차전지·소재 · 소프트웨어·인터넷·게임 · 지주는 담당자와 제출일이 비어 있다. 팀장이 확인한다.', BAD),
 ...
 2: lambda d, n, c, b: [
    (f'완료 {d}/{n}.  방산·우주는 팀 1 정리본에 작성돼 있어 여기로 옮겼다. 담당자가 기재되지 않았으므로 팀장이 확인한다.', BAD),
